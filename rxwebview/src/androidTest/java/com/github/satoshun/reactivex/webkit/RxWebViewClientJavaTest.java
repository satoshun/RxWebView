...
// todo remove it's on version 3
@LargeTest
@RunWith(AndroidJUnit4.class)
public class RxWebViewClientJavaTest {
  @Rule
  ...
  public void events() throws Exception {
    TestObserver<RxWebViewClientData> o = RxWebViewClient.events(activity.getWebView())
        ...
        .doOnSubscribe(new Consumer<Disposable>() {
          ...
          public void accept(Disposable disposable) throws Exception {
            activity.getWebView().loadUrl("https://www.google.com/");
          }
        })
